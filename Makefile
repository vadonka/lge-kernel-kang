...
CFLAGS_MODULE	+= -DCONFIG_MACH_STAR_$(TARGET_STAR_HWREV)
CFLAGS_KERNEL	+= -DCONFIG_MACH_STAR_$(TARGET_STAR_HWREV)
...
#todo : remove it.
CFLAGS_MODULE	+= -D$(STAR_TMUS_REV)
CFLAGS_KERNEL	+= -D$(STAR_TMUS_REV)

# 20100705, sunghoon.kim@lge.com,[LGE_END]

#jyothi change S
ifeq ($(TARGET_MODEM),mdm)
CFLAGS_KERNEL += -DCONFIG_MODEM_MDM
endif
ifeq ($(TARGET_MODEM),ifx)
CFLAGS_KERNEL += -DCONFIG_MODEM_IFX
endif
#end
