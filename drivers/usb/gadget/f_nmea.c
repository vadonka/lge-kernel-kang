...
// yongkyun.lee@lge.com 2011/4/6: START ==> 
...
#ifdef NMEA_INTERFACE_ENDPOINT	
// yongkyun.lee@lge.com 2011/4/4: START ==> 
...
#ifdef NMEA_INTERFACE_ENDPOINT	
// yongkyun.lee@lge.com 2011/4/4: START ==>  짝을 맞추기 위해 우선은 받아 놓는다..
...
#ifdef NMEA_INTERFACE_ENDPOINT	
	// yongkyun.lee@lge.com 2011/4/4: START ==> 
	printk("f_nmea : ger_bind in ep = %d, out ep = %d, noti ep=%d\n ",\
		gser_hs_in_desc.bEndpointAddress  ,gser_hs_out_desc.bEndpointAddress , gser_hs_notify_desc.bEndpointAddress  );
	// yongkyun.lee@ lge.com END 
#endif//
