...
static int mmc_blk_issue_rq(struct mmc_queue *mq, struct request *req)
{
	...
	do {
		 ...
		 */
//20110123, jm1.lee@lge.com, do not redo I/O when nomedium error [START]
		if (brq.cmd.error == -ENOMEDIUM) {
			goto cmd_err;
		}
//20110123, jm1.lee@lge.com, do not redo I/O when nomedium error [END]
 ...
 cmd_err:
	...
	while (ret)
	{
//20110123, jm1.lee@lge.com, supressed the error message
