/*
 * arch/arm/mach-tegra/odm_kit/query/whistler/subboards/nvodm_query_discovery_e1219_peripherals.h
 *
 * Specifies the peripheral connectivity database peripheral entries for the E1219 COMMS module
 *
